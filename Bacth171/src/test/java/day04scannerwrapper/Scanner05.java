...
public class Scanner05 {
    public static void main(String[] args) {
        ...
        int onlarBasabagı = number % 10;
        //sayiyi kucult
        number = number / 10;

        //sondan ucuncu rakami al
        int yuzlerBasamagı = number % 10;
        //sayiyi kucult
        number = number / 10;

        //sondan dorduncu rakami al
        int binlerBasamagı =number%10;
        //sayi yi kucult
        number = number/10;

        //sondan besinci rakami al
        int onbinlerBasamagı =number%10;
        //son rakam oldugu icin kucultmeye gerek yok

        System.out.println(onbinlerBasamagı+binlerBasamagı+yuzlerBasamagı+onbinlerBasamagı+binlerBasamagı);

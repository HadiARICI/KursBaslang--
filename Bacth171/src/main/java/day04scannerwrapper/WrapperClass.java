...
public class WrapperClass {
    public static void main(String[] args) {
        ...
        Double minDob=Double.MIN_VALUE;
        System.out.println("minDob = " + minDob);

        int minınt =Integer.MIN_VALUE;
        System.out.println("minınt = " + minınt);

        byte maxByte= m.byteValue();
        System.out.println("maxByte = " + maxByte);

        char inial ='a';// bu işleme Autoboxing
        Character initialWrapper=inial;

        Boolean isOldWrapper=true;//Unboxing

        boolean isOldPriwiti=isOldWrapper;

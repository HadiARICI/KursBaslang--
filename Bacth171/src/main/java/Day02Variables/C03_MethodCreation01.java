...
public class C03_MethodCreation01 {
    /*
   ...
   4) method name + parametreler ==> method signature
    ...
    public static void main(String[] args) {
        ...
        int dikdorgenAlanı = dikalanhesaplama(7, 8);
        System.out.println("dikdörtgen Alan :" + dikdorgenAlanı);

    int dikdorgenCevreHesapla = dikcevrehesapla(8, 9);
        System.out.println("dikdöergen Cevre Hesapla:"+dikdorgenCevreHesapla);

        int sayiToplamaCarma=toplacarma(5,6,7);

        System.out.println("Topla Carpama :"+sayiToplamaCarma);
}

    public static int toplacarma(int a, int b, int c) {
        return (a*b)+c;
    }

    public static int dikcevrehesapla(int c, int d) {
        return 2*(c+d);

    }

    public static int dikalanhesaplama(int a, int b) {
        return  a*b;
    }
